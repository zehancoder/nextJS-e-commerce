...
function page() {
  return (
    <div classNameName="w-full min-h-screen relative flex items-center justify-center">
      <div className="max-w-6xl max-lg:max-w-3xl mx-auto bg-white p-4">
        <div className="text-center px-6">
          <h2 className="text-slate-900 text-5xl font-bold">Contact Us</h2>
          <p className="text-[15px] text-slate-600 mt-4">
            Have some big idea or brand to develop and need help?
          </p>
        </div>
        <div className="grid mt-4 lg:grid-cols-2 gap-16 items-center relative overflow-hidden p-8 [box-shadow:0_2px_10px_-3px_rgba(6,81,237,0.3)] before:absolute before:right-0 before:w-[300px] before:bg-blue-400 before:h-full max-lg:before:hidden">
          <div>
